...
import { getAvailable } from "@features/budget/api/get-available";

function AvailableCard() {
  const dispatch = useDispatch();
  const user = useSelector(state => state.auth.user);
  const isAvailableLoading = useSelector(state => state.budget.available.isLoading);
  const available = useSelector(state => state.budget.available.data);
